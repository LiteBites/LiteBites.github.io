...
<figure>
  <img src="{{ '/assets/images/papers/vit-comer/method-03.png' | relative_url }}" alt="ViT-CoMer architecture showing a plain ViT branch, a CNN feature branch, and interaction modules between them." />
  <figcaption>Paper figure: ViT-CoMer keeps a plain ViT backbone, then adds a CNN branch and repeated interaction modules so multi-scale convolutional features can strengthen dense prediction.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/papers/vit-comer/results-01.png' | relative_url }}" alt="Object detection performance plot on COCO comparing ViT-CoMer with plain ViT and other dense prediction backbones." />
  <figcaption>Paper figure: the main result to watch is that ViT-CoMer improves dense prediction performance while still reusing strong plain-ViT pretraining rather than redesigning the whole backbone.</figcaption>
</figure>
