...
<figure>
  <img src="{{ '/assets/images/papers/lora/results-02.png' | relative_url }}" alt="LoRA results page comparing GPT-3 adaptation methods, including trainable parameter counts and downstream performance." />
